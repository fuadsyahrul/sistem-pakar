...
?>
	...
	switch ($_GET[act]) {
		...
		default:
		  ...
		  <tr><td><input class='btn bg-primary margin' type=button name=tambah value='Tambah Gejala' onclick=\"window.location.href='gejala/tambahgejala';\"><input type=text name='keyword' style='margin-left: 10px;' placeholder='Ketik dan tekan cari...' class='form-control' value='$_POST[keyword]' /> <input class='btn bg-primary margin' type=submit value='   Cari   ' name=Go></td> </tr>
          </table></form>";
		  ...
		  <tbody>";
			 ...
			 <td>$r[nama_gejala]</td>
			 <td align=center><a type='button' class='btn btn-primary margin' href=gejala/editgejala/$r[kode_gejala]><i class='fa fa-pencil-square-o' aria-hidden='true'></i> Ubah </a> &nbsp;
	          <a type='button' class='btn btn-warning margin' href=\"JavaScript: confirmIt('Anda yakin akan menghapusnya ?','$aksi?module=gejala&act=hapus&id=$r[kode_gejala]','','','','u','n','Self','Self')\" onMouseOver=\"self.status=''; return true\" onMouseOut=\"self.status=''; return true\"><i class='fa fa-trash-o' aria-hidden='true'></i> Hapus</a>
             </td></tr>";
						$no++;
						$counter++;
					}
		  ...
		  ";
			 ...
			 <td>$r[nama_gejala]</td>
			 <td align=center>
			 <a type='button' class='btn btn-primary margin' href=gejala/editgejala/$r[kode_gejala]><i class='fa fa-pencil-square-o' aria-hidden='true'></i> Ubah </a> &nbsp;
	          <a type='button' class='btn btn-warning margin' href=\"JavaScript: confirmIt('Anda yakin akan menghapusnya ?','$aksi?module=gejala&act=hapus&id=$r[kode_gejala]','','','','u','n','Self','Self')\" onMouseOver=\"self.status=''; return true\" onMouseOut=\"self.status=''; return true\"><i class='fa fa-trash-o' aria-hidden='true'></i> Hapus</a>
             </td></tr>";
						$no++;
						$counter++;
		...
		case "tambahgejala":
		  ...
		  <input class='btn btn-warning' type=button name=batal value='Batal' onclick=\"window.location.href='?module=gejala';\"></td></tr>
          </table></form>";
			break;
		...
		case "editgejala":
          ...
          <tr><td></td><td><input class='btn btn-primary' type=submit name=submit value='Simpan' >
		  <input class='btn btn-warning' type=button value='Batal' onclick=\"window.location.href='?module=gejala';\"></td></tr>
          </table></form>";
			break;
	}
	?>
