...
switch ($_GET[act]) {
      ...
      if ($numrows > 0) {
        ...
        while ($r = mysqli_fetch_array($hasil)) {
          ...
          echo "<tr class='" . $warna . "'>
			 ...
			 <td>$r[det_post]</td>
			 <td>$r[srn_post]</td>
			 <td align=center><a type='button' class='btn btn-primary margin' href=post/editpost/$r[kode_post]><i class='fa fa-pencil-square-o' aria-hidden='true'></i> Ubahx </a> &nbsp;
	          <a type='button' class='btn btn-warning margin' href=\"JavaScript: confirmIt('Anda yakin akan menghapusnya ?','$aksi?module=post&act=hapus&id=$r[kode_post]','','','','u','n','Self','Self')\" onMouseOver=\"self.status=''; return true\" onMouseOut=\"self.status=''; return true\"> <i class='fa fa-trash-o' aria-hidden='true'></i> Hapus</a>
             </td></tr>";
          $no++;
          $counter++;
        }
      ...
      if ($baris > 0) {
        ...
        while ($r = mysqli_fetch_array($hasil)) {
          ...
          echo "<tr class='" . $warna . "'>
			 ...
			 <td>$r[srn_post]</td>
			 <td align=center>
			 <a type='button' class='btn btn-primary margin' href=post/editpost/$r[kode_post]><i class='fa fa-pencil-square-o' aria-hidden='true'></i> Ubah </a> &nbsp;
	          <a type='button' class='btn btn-warning margin' href=\"JavaScript: confirmIt('Anda yakin akan menghapusnya ?','$aksi?module=post&act=hapus&id=$r[kode_post]','','','','u','n','Self','Self')\" onMouseOver=\"self.status=''; return true\" onMouseOut=\"self.status=''; return true\">
  ...
  case "tambahpost":
    echo "<form name=text_form method=POST action='$aksi?module=post&act=input' onsubmit='return Blank_TextField_Validator()' enctype='multipart/form-data'>
		  ...
		  <input class='btn btn-warning' type=button name=batal value='Batal' onclick=\"window.location.href='?module=post';\"></td></tr>
          </table></form>";
    break;
