...
?>
	...
	switch ($_GET[act]) {
		...
		default:
		  ...
		  <tr><td><input class='btn bg-primary margin' type=button name=tambah value='Tambah Admin' onclick=\"window.location.href='admin/tambahadmin';\"><input type=text name='keyword' style='margin-left: 10px;' placeholder='Ketik dan tekan cari...' class='form-control' value='$_POST[keyword]' /> <input class='btn bg-primary margin' type=submit value='   Cari   ' name=Go></td> </tr>
          </table></form>";
		  ...
		  ";
	         ...
	         <td>$r[nama_lengkap]</td>
			 <td align=center>
			 <a type='button' class='btn btn-primary margin' href=admin/editadmin/$r[username]><i class='fa fa-pencil-square-o' aria-hidden='true'></i> Ubah </a> &nbsp;
	          <a type='button' class='btn btn-warning margin' href=\"JavaScript: confirmIt('Anda yakin akan menghapusnya ?','$aksi?module=admin&act=hapus&id=$r[username]','','','','u','n','Self','Self')\" onMouseOver=\"self.status=''; return true\" onMouseOut=\"self.status=''; return true\"><i class='fa fa-trash-o' aria-hidden='true'></i> Hapus</a>
             </td></tr>";
						$no++;
						$counter++;
					}
		...
		case "tambahadmin":
		  ...
		  <input class='btn btn-warning' type=button name=batal value='Batal' onclick=\"window.location.href='?module=admin';\">
		  </td></tr>
          </table></form>";
			break;
		...
		case "editadmin":
          ...
          <tr><td></td><td>
		  <input class='btn btn-primary' type=submit name=submit value='Simpan' >
		  <input class='btn btn-warning' type=button name=batal value='Batal' onclick=\"window.location.href='?module=admin';\"></td></tr>
          </table></form>";
			break;
	}
	?>
