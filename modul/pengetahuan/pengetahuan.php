...
?>
	...
	switch ($_GET[act]) {
		...
		default:
		  ...
		  <tr><td><input class='btn bg-primary margin' type=button name=tambah value='Tambah Basis Pengetahuan' onclick=\"window.location.href='pengetahuan/tambahpengetahuan';\"><input type=text name='keyword' style='margin-left: 10px;' placeholder='Ketik dan tekan cari...' class='form-control' value='$_POST[keyword]' /> <input class='btn bg-primary margin' type=submit value='   Cari   ' name=Go></td> </tr>
          </table></form>";
		  ...
		  <tbody>";
			 ...
			 <td align=center><a type='button' class='btn btn-primary margin' href=pengetahuan/editpengetahuan/$r[kode_pengetahuan]><i class='fa fa-pencil-square-o' aria-hidden='true'></i> Ubah </a> &nbsp;
	          <a type='button' class='btn btn-warning margin' href=\"JavaScript: confirmIt('Anda yakin akan menghapusnya ?','$aksi?module=pengetahuan&act=hapus&id=$r[kode_pengetahuan]','','','','u','n','Self','Self')\" onMouseOver=\"self.status=''; return true\" onMouseOut=\"self.status=''; return true\"><i class='fa fa-trash-o' aria-hidden='true'></i> Hapus</a>
             </td></tr>";
						$no++;
						$counter++;
					}
		  ...
		  ";
			 ...
			 <td align=center>$r[md]</td>
			 <td align=center>
			 <a type='button' class='btn btn-primary margin' href=pengetahuan/editpengetahuan/$r[kode_pengetahuan]><i class='fa fa-pencil-square-o' aria-hidden='true'></i> Ubah </a> &nbsp;
	          <a type='button' class='btn btn-warning margin' href=\"JavaScript: confirmIt('Anda yakin akan menghapusnya ?','$aksi?module=pengetahuan&act=hapus&id=$r[kode_pengetahuan]','','','','u','n','Self','Self')\" onMouseOver=\"self.status=''; return true\" onMouseOut=\"self.status=''; return true\">
		...
		case "tambahpengetahuan":
			echo "	<div class='alert alert-success alert-dismissible'>
				...
				<b>1.0</b> (Sangat Yakin)&nbsp;&nbsp;|&nbsp;&nbsp;<b>0.8</b> (Yakin)&nbsp;&nbsp;|<br>
				<b>0.6</b> (Cukup Yakin)&nbsp;&nbsp;|&nbsp;&nbsp;<b>0.4</b> (Sedikit Yakin)&nbsp;&nbsp;|<br>
				<b>0.2</b> (Tidak Tahu)&nbsp;&nbsp;|&nbsp;&nbsp;<b>0.0</b> (Tidak)&nbsp;&nbsp;|<br><br>
				...
				<b>Contoh:</b><br>
				Jika kepercayaan <b>(MB)</b> anda terhadap gejala Lemas untuk penyakit Panleukopenia adalah <b>0.8 (Yakin)</b><br>
				Dan ketidakpercayaan <b>(MD)</b> anda terhadap gejala Lemas untuk penyakit Panleukopenia adalah <b>0.2 (Tidak Tahu)</b><br><br>
				<b>Maka:</b> CF(Pakar) = MB – MD (0.8 - 0.2) = <b>0.6</b> <br>
				Dimana nilai kepastian anda terhadap gejala Lemas untuk penyakit Panleukopenia adalah <b>0.6 (Cukup Yakin)</b>
              </div>
		...
		<tr><td>MD</td><td><input autocomplete='off' placeholder='Masukkan MD' type=text class='form-control' name='md' size=15></td></tr>
		  <tr><td></td><td><input class='btn btn-primary' type=submit name=submit value='Simpan' >
		  <input class='btn btn-warning' type=button name=batal value='Batal' onclick=\"window.location.href='?module=pengetahuan';\"></td></tr>
          </table></form>";
			break;
