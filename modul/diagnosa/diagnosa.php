...
switch ($_GET['act']) {
  ...
  default:
    if ($_POST['submit']) {
      $arcolor = array('#ffffff', '#ABB5EE', '#DC95DD', '#FAAFA5', '#F6E785', '#9FE481', '#67D0DD');
	...
	<h2 class='text'>Hasil Diagnosis &nbsp;&nbsp;<button id='print' onClick='window.print();' data-toggle='tooltip' data-placement='right' title='Klik tombol ini untuk mencetak hasil diagnosa'><i class='fa fa-print'></i> Cetak</button> </h2>
      ...
      foreach ($argejala as $key => $value) {
        ...
        echo '<td><span class="hasil text">' . $r4[nama_gejala] . "</span></td>";
      ...
      echo "
	 <h2 class='text'>Diagnosis Penyakit</h2>  <hr>
	 <div class='alert alert-success alert-dismissible'>
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
                <h4><i class='icon fa fa-exclamation-triangle'></i>Perhatian !</h4>
                Silahkan memilih gejala sesuai dengan kondisi kucing anda, anda dapat memilih kepastian kondisi kucing dari pasti tidak sampai pasti ya, jika sudah tekan tombol proses (<i class='fa fa-search-plus'></i>)  di bawah untuk melihat hasil.
              </div>
...
?>
        ...
        <script type="text/javascript">
          $(document).ready(function() {
            var arcolor = new Array('#ffffff', '#ABB5EE', '#DC95DD', '#FAAFA5', '#F6E785', '#9FE481', '#67D0DD');
            setColor();
...
<?php
      ...
      echo "
		  <input class='float' type=submit data-toggle='tooltip' data-placement='top' title='Klik disini untuk melihat hasil diagnosis' name=submit value='&#xf00e;' style='font-family:Arial, FontAwesome'>
          </tbody></table></form>";
    }
    break;
}
