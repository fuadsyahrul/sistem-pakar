  ...
  switch ($_GET[act]) {
        ...
        if ($numrows > 0) {
          ...
          while ($r = mysqli_fetch_array($hasil)) {
            ...
            echo "<tr class='" . $warna . "'>
			 ...
			 <td align=center><a type='button' class='btn btn-block btn-primary' href=penyakit/editpenyakit/$r[kode_penyakit]><i class='fa fa-pencil-square-o' aria-hidden='true'></i> Ubah </a> &nbsp;
	          <a type='button' class='btn btn-block btn-warning' href=\"JavaScript: confirmIt('Anda yakin akan menghapusnya ?','$aksi?module=penyakit&act=hapus&id=$r[kode_penyakit]','','','','u','n','Self','Self')\" onMouseOver=\"self.status=''; return true\" onMouseOut=\"self.status=''; return true\"> <i class='fa fa-trash-o' aria-hidden='true'></i> Hapus</a>
             </td></tr>";
            $no++;
            $counter++;
          }
        ...
        if ($baris > 0) {
          ...
          while ($r = mysqli_fetch_array($hasil)) {
            ...
            echo "<tr class='" . $warna . "'>
			 ...
			 <td>$r[srn_penyakit]</td>
			 <td align=center>
			 <a type='button' class='btn btn-block btn-primary' href=penyakit/editpenyakit/$r[kode_penyakit]><i class='fa fa-pencil-square-o' aria-hidden='true'></i> Ubah </a> &nbsp;
	          <a type='button' class='btn btn-block btn-warning' href=\"JavaScript: confirmIt('Anda yakin akan menghapusnya ?','$aksi?module=penyakit&act=hapus&id=$r[kode_penyakit]','','','','u','n','Self','Self')\" onMouseOver=\"self.status=''; return true\" onMouseOut=\"self.status=''; return true\">
    ...
    case "tambahpenyakit":
      echo "<form name=text_form method=POST action='$aksi?module=penyakit&act=input' onsubmit='return Blank_TextField_Validator()' enctype='multipart/form-data'>
		  ...
		  <input class='btn btn-warning' type=button name=batal value='Batal' onclick=\"window.location.href='?module=penyakit';\"></td></tr>
          </table></form>";
      break;
