...
<h2 class='text'>Informasi Penyakit Kucing</h2>
<hr>
<div class="row">
      ...
      <div class="card text-center">
        ...
        <div class="card-block">
          <h4 class="card-title">
            ...
            <!-- Tombol Detail -->
            <a class="btn bg-blue btn-flat margin" href="#" data-toggle="modal" data-target="#modal<?php echo $r['kode_post']; ?>"><i class="fa fa-puzzle-piece" aria-hidden="true"></i> Detail</a>

            <!-- Tombol Saran -->
            <a class="btn bg-yellow btn-flat margin" href="#" data-toggle="modal" data-target="#modaltindakan<?php echo $r['kode_post']; ?>"><i class="fa fa-quote-right" aria-hidden="true"></i> Saran</a>
        </div>
      </div>
      <hr>
    </div>
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          <div class="modal-header detail-ket">
            ...
            <h4 class="modal-title text text-ket"><i class="fa fa-puzzle-piece" aria-hidden="true"></i> <?php echo $r['nama_post']; ?></h4>
          </div>
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          <div class="modal-header saran-ket">
            <button type="button" class="close" data-dismiss="modal" style="opacity: .99;color: #fff;">&times;</button>
            <h4 class="modal-title text text-ket"><i class="fa fa-quote-right" aria-hidden="true"></i> <?php echo $r['nama_post']; ?></h4>
          </div>
          <div class="modal-body" style="text-align: justify;text-justify: inter-word;">
