...
<head>
    ...
    <base href="http://localhost/catcat/">
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="./" class="logo">
                ...
                <span class="logo-lg"><b><i class="fa fa-contao" aria-hidden="true"></i>at Care</b></span>
            </a>
            <!-- Header Navbar -->
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        ...
                        ?>
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="gambar/admin/favicon.png" class="user-image" alt="User Image"> <?php echo ucfirst($_SESSION['username']); ?>
                                    <span class="hidden-xs"><?php echo $user; ?></span>
                                </a>
                                <ul class="dropdown-menu">
                                    <!-- User image -->
                                    <li class="user-header">
                                        <img src="gambar/admin/favicon.png" class="img-circle" alt="User Image">
                                        <p>
                                    ...
                                    <li class="user-footer">
                                        ...
                                        <div class="pull-right">
                                            <a class="btn btn-default btn-flat" href="JavaScript: confirmIt('Apakah anda yakin akan LogOut ?','logout.php','','','','u','n','Self','Self')" onMouseOver="self.status = ''; return true" onMouseOut="self.status = ''; return true"><i class="fa fa-sign-out"></i> <span>LogOut</span></a>
                                        </div>
                                    </li>
                                </ul>
                            </li>
                        <?php } else { ?>
                            <li>
                                <a <?php if ($module == "bantuan") echo 'class="active"'; ?> id="bantu" href="bantuan" data-toggle="tooltip" data-placement="bottom" data-delay='{"show":"300", "hide":"500"}' title="Silahkan klik link berikut, jika anda masih kurang paham tentang penggunaan aplikasi ini !"><i class="fa fa-question-circle"></i> <span>Panduan User</span></a>
                            </li>
        ...
        <footer class="main-footer">
            ...
            <button class="kontak ke-kanan" data-toggle="modal" data-target="#modalForm">
                <i class="fa fa-envelope-square"></i> Kontak Admin</button>
            <!-- Modal -->
                ...
                <div class="modal-dialog">
                    <div class="modal-content" style="max-width: 450px;">
                        ...
                        <div class="modal-header mdl-kontak">
                            ...
                            <h4 class="text-ket" id="labelModalKu"><i class="fa fa-envelope-square"></i> Kontak Admin</h4>
                        </div>
                        <!-- Modal Body -->
            ...
            <!-- Footer -->
            <strong>
                <div class="cinta">2023 - Made with <i class="fa fa-heart pulse"></i> by <a href="https://www.linkedin.com/in/fuadsyalah/" target="_blank">Fuadsyalah</a></div>
            </strong>
        </footer>
